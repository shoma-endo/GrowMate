-- Extend the analytics list RPC with GA4 evaluation filtering and projection fields.
...
revoke execute on function public.get_filtered_content_annotations(uuid, integer, integer, text[], boolean, boolean, boolean, boolean) from public, anon, authenticated;
grant execute on function public.get_filtered_content_annotations(uuid, integer, integer, text[], boolean, boolean, boolean, boolean) to service_role;

-- Rollback: drop function if exists public.get_filtered_content_annotations(uuid, integer, integer, text[], boolean, boolean, boolean, boolean);
