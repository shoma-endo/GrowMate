...
class GoogleAdsAiAnalysisService {
  ...
  private formatSearchTermMetrics(metrics: GoogleAdsSearchTermMetric[]): string {
    const header = '検索語句 | 表示回数 | クリック数 | CV数';
    const separator = '--------|--------|----------|------';
...
const DEV_SAMPLE_SEARCH_TERMS: GoogleAdsSearchTermMetric[] = [
  { searchTerm: 'エアコンクリーニング', impressions: 3200, clicks: 128, conversions: 4 },
  { searchTerm: 'エアコン クリーニング 料金', impressions: 2100, clicks: 189, conversions: 8 },
  { searchTerm: 'エアコン 掃除 業者 おすすめ', impressions: 1850, clicks: 92, conversions: 3 },
  { searchTerm: 'エアコンクリーニング 一台 いくら', impressions: 1620, clicks: 145, conversions: 6 },
  { searchTerm: 'エアコン 分解洗浄 業者', impressions: 980, clicks: 78, conversions: 2 },
  { searchTerm: 'エアコン内部 カビ 掃除', impressions: 870, clicks: 43, conversions: 1 },
  { searchTerm: '壁掛けエアコン クリーニング 料金', impressions: 760, clicks: 68, conversions: 2 },
  { searchTerm: 'エアコン 臭い 洗浄', impressions: 640, clicks: 38, conversions: 0 },
  { searchTerm: 'エアコンクリーニング プロ 頼む', impressions: 520, clicks: 46, conversions: 1 },
  { searchTerm: 'エアコン 丸洗い 費用', impressions: 410, clicks: 20, conversions: 0 },
];
