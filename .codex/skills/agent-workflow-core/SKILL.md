...
description: AGENTS.md の最小コア運用を補完する共通ワークフロー。Skill選定、client-alignment-auditor発火条件、段階的開示ルールを定義する。
---
...
- `AGENTS.md` は常時読み込みされるため、普遍的な最小方針のみを保持する。
...
- `AGENTS.md` には「普遍的に効く事実」と「最小手順」だけを書く。
